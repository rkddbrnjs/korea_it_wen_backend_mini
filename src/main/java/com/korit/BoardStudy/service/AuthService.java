...
public class AuthService {
    ...
    public ApiRespDto<?> signin(SigninReqDto signinReqDto){
        ...
        if (optionalUser.isEmpty()){
            return new ApiRespDto<>("failed","아이디 또는 비밀번호를 확인하세요.",null);
        }
        User user = optionalUser.get();
